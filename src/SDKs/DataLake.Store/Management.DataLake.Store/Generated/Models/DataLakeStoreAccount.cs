...
namespace Microsoft.Azure.Management.DataLake.Store.Models
{
    ...
    public partial class DataLakeStoreAccount : Resource
    {
        ...
        /// <summary>
        /// Gets or sets the data replication type for this Data Lake Store
        /// account. The options are LRS (local redundant storage, the default)
        /// and RAGRS (read access geo-redundant storage). Possible values
        /// include: 'LRS', 'RAGRS'
        /// </summary>
        [JsonProperty(PropertyName = "properties.replicationType")]
        public ReplicationType? ReplicationType { get; set; }

        /// <summary>
        /// Gets the location in which the storage account is being replicated.
        /// This is set for RAGRS replication types.
        /// </summary>
        [JsonProperty(PropertyName = "properties.secondaryLocation")]
        public string SecondaryLocation { get; private set; }

        /// <summary>
        /// Gets the secondary endpoint of the account in the secondary
        /// location. This is set for RAGRS replication types.
        /// </summary>
        [JsonProperty(PropertyName = "properties.secondaryEndpoint")]
