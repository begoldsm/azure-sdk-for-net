...
namespace Microsoft.Azure.Management.DataLake.Store.Models
{
    ...
    public partial class DataLakeStoreAccountUpdateParameters
    {
        ...
        /// <param name="replicationType">The data replication type to update
        /// to for this Data Lake Store account. The options are LRS (local
        /// redundant storage) and RAGRS (read access geo-redundant storage).
        /// Possible values include: 'LRS', 'RAGRS'</param>
        public DataLakeStoreAccountUpdateParameters(IDictionary<string, string> tags = default(IDictionary<string, string>), FirewallState? firewallState = default(FirewallState?), TrustedIdProviderState? trustedIdProviderState = default(TrustedIdProviderState?), string defaultGroup = default(string), TierType? newTier = default(TierType?), FirewallAllowAzureIpsState? firewallAllowAzureIps = default(FirewallAllowAzureIpsState?), UpdateEncryptionConfig encryptionConfig = default(UpdateEncryptionConfig), ReplicationType? replicationType = default(ReplicationType?))
        {
            Tags = tags;
        ...
        /// <summary>
        /// Gets or sets the data replication type to update to for this Data
        /// Lake Store account. The options are LRS (local redundant storage)
