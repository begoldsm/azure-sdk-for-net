...
namespace Microsoft.Azure.Management.DataLake.Analytics
{
    ...
    public static partial class HiveMetastoresOperationsExtensions
    {
            ...
            {
                return operations.GetAsync(resourceGroupName, accountName, hiveMetastoreName).GetAwaiter().GetResult();
            }
            ...
            {
                operations.DeleteAsync(resourceGroupName, accountName, hiveMetastoreName).GetAwaiter().GetResult();
            }
            ...
            {
                (await operations.DeleteWithHttpMessagesAsync(resourceGroupName, accountName, hiveMetastoreName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            {
                operations.UpdateAsync(resourceGroupName, accountName, hiveMetastoreName, parameters).GetAwaiter().GetResult();
            }
            ...
            {
                (await operations.UpdateWithHttpMessagesAsync(resourceGroupName, accountName, hiveMetastoreName, parameters, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            {
                operations.AddAsync(resourceGroupName, accountName, hiveMetastoreName, parameters).GetAwaiter().GetResult();
            }
            ...
            {
                (await operations.AddWithHttpMessagesAsync(resourceGroupName, accountName, hiveMetastoreName, parameters, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            {
                return ((IHiveMetastoresOperations)operations).ListByAccountAsync(resourceGroupName, accountName, odataQuery, select, count).GetAwaiter().GetResult();
            }
