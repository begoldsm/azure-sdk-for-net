...
namespace Microsoft.Azure.Management.DataLake.Store.Models
{
    ...
    public partial class DataLakeStoreAccount
    {
        ...
        /// properties.</param>
        public DataLakeStoreAccount(string location = default(string), string name = default(string), string type = default(string), string id = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), DataLakeStoreAccountProperties properties = default(DataLakeStoreAccountProperties))
        {
            Location = location;
            Name = name;
            Type = type;
